...
```
var xpath = require('atropa-xpath').xpath;
console.log(xpath);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-xpath_web.js` in your page and
 `atropa.xpath` will be available in your page.
...
To run the browser tests open `browser/atropa-xpath_tests.html` in your
...
If you alter the source in `src/atropa-xpath.js` please run the
